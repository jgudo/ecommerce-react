...
const Payment = ({
	...
	const collapseCreditHeight = useRef<HTMLElement | null>(null);
	...
	const onCreditModeChange = (e: React.ChangeEvent<HTMLInputElement>): void => {
		...
		if (cardInputRef.current && collapseCreditHeight.current) {
	...
	const onPayPalModeChange = (): void => {
		...
		if (collapseCreditHeight.current?.parentElement) {
