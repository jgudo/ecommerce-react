...
interface IProps {
	...
	onDeleteSelectedColor: (color: string) => void;
	onAddSelectedColor: (color: string) => void;
}

const InputColor: React.FC<IProps> = ({ availableColors, onDeleteSelectedColor, onAddSelectedColor }) => {
